...
export function AddOrderForm(props) {
  ...
  useEffect(() => getProducts(), []); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  useEffect(() => addProductList(), [formik.values]); // eslint-disable-line react-hooks/exhaustive-deps
